...
function isInsideCircle(circle, point) {
  const first = (point.x - circle.center.x) * (point.x - circle.center.x);
  const second = (point.y - circle.center.y) * (point.y - circle.center.y);
